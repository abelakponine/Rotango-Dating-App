...
<body>
	<div class="overlayer relative" style="background:#24242499; z-index:1"></div>
	<div class="container-fluid d-flex flex-column relative" style="z-index:2;">
		...
		<div id="login-form" class="d-flex flex-column mx-auto mb-4 pb-4" style="width:85%;height:100%;">
				...
				<h1 class="my-3 mx-auto alt-text-color"
					style="width: max-content; font-size: calc(16px + 2.4vmin); font-family:monospace; color:#404040;
							margin:14vh auto 10px auto !important;font-weight:bold;">
							<img alt="logo" src="images/rotango.png" style="display:inline-block;width:40px;margin-left:-24px;"> Rotango<sup>&trade;</sup></h1>
							<strong class="d-block mx-auto alt-text-color" style="margin-bottom:30px !important;
								color:#404040; font-size:calc(14px + .1vmin); text-align:center; font-family:;monospace;
								font-style:italic;word-spacing:0px;">A long lasting spice for your love life...</strong>
			...
			<form class="mt-0 mb-4 mx-auto" style="width:100%; max-width:500px">
				...
				<fieldset style="border-top: 1px solid #dadada;margin: 16px auto;">
						<legend style="float: none;width: max-content;padding: 0 20px;margin: auto;color: #606060;font-size:15px;color:white;">or</legend>
				</fieldset>
				
				<input placeholder="Username" class="form-control my-2 border-1" style="border-color:#d4d4d4;box-shadow:none;border-radius:20px;" required/>
				<input placeholder="Password" class="form-control my-2 border-1" style="border-color:#d4d4d4;box-shadow:none;border-radius:20px;" required/>
				<button class="btn btn-primary theme-bg-color text-white bg-dark my-2 py-2" style="width:100%;border-radius:20px;box-shadow:none;border:0;">Login</button>
				<div class="mt-3 mb-4" style="width:100%;text-align:center;">
					<strong class="d-block alt-text-color">Don't have an account?</strong>
					<a href="#register" style="color:#f77fca;text-decoration: none;" onclick="startNewReg(event)">Register here</a>
				</div>
			</form>
		</div>
		
		<!--  Registration Forms -->
		<div id="registration-form" class="fixed" style="display:none;background:#fffffffc; width:100%; height:100%; left:0; z-index:10; overflow-y:auto;">
				
				<div class="d-flex flex-column my-4 px-3" style="width:100%; height:max-content;">
					<button class="btn close ml-auto" style="background:#eaeaea;border-radius:50%;padding:5px 10px 3px 10px" onclick="closeRegForm(event)"><i class="far fa-times" style="font-size:24px;"></i></button>
								...
								<input placeholder="Password" class="form-control my-2" required>
									...
									<div class="d-flex mt-5 p-1">
											<button style="border-radius:25px;" onclick="nextRegStep(event, 2);" class="btn theme-bg-color text-white  mt-auto mb-auto p-2 ml-auto d-flex">
												Continue &nbsp; <i class="fa fa-arrow-right m-auto text-white mr-1" style="border-radius:50%;"></i>
											</button>
									</div>
